        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="product_name" class="form-control" placeholder="Ingrese Nombre del Producto">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<textarea class="form-control" name="product_desc" placeholder="Ingrese descripción del producto"></textarea>
		        	</div>
        		</div>
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="number" name="product_price" class="form-control" placeholder="Ingrese precio del producto">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <textarea class="form-control" name="e_product_desc" placeholder="Ingrese descripción del producto"></textarea>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Cantidad del Producto</label>
                <input type="number" name="e_product_qty" class="form-control" placeholder="Ingrese cantidad del producto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Precio del Producto</label>
                <input type="number" name="e_product_price" class="form-control" placeholder="Ingrese precio del producto">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
