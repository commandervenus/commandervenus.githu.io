  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_category_modal" class="btn btn-warning btn-sm">Agregar categoría </a>
      	</div>
      </div>
        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<input type="text" name="cat_title" class="form-control" placeholder="Ingresa nombre de la Categoría">
		        	</div>
        		</div>
        ...
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-12">
              ...
              <div class="form-group">
                <label>Nombre de la Categoría</label>
                <input type="text" name="e_cat_title" class="form-control" placeholder="Ingresa nombre de la Categoría">
              </div>
            </div>
